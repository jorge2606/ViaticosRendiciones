...
var MotiveService = /** @class */ (function () {
    ...
    MotiveService.prototype.getAll = function () {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "Motive/GetAll/");
    };
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            ...
            imports: [
                ...
                ngx_toastr__WEBPACK_IMPORTED_MODULE_71__["ToastrModule"].forRoot() // ToastrModule added
            ],
            providers: [
...
var CreateSolicitationComponent = /** @class */ (function () {
    function CreateSolicitationComponent(route, router, motiveService, expenditureService, modalService, destinyService, provinceService, cityService, categoryService, transportService, countryService, codeLiquidationService, solicitationSubsidyService, expenditureAgentService, titleService, toastrService) {
        this.route = route;
        this.router = router;
